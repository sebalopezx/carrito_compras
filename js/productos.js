...
// console.log(COMESTIBLES[0])
// console.log(COMESTIBLES[0][0])
// console.log(COMESTIBLES[0][3])
// console.log(COMESTIBLES[0][3][0])

// console.log(BEBESTIBLES[0][3][0])
...
const crearComestible = (i) => {
    let imagen = COMESTIBLES[i][0];
    let nombre = COMESTIBLES[i][1];
    let precio = COMESTIBLES[i][2];
    let precioCLP = formatoCLP(precio);
    let ingredientes = crearIngredientesHTML(COMESTIBLES[i][3]);
    const comestibleHTML = `<article class="col-6 col-sm-6 col-md-4 col-lg-3 my-2 my-md-3 p-1 border border-primary rounded ">
...
const crearBebestible = (i) => {
    let imagen = BEBESTIBLES[i][0];
    let nombre = BEBESTIBLES[i][1];
    let precio = BEBESTIBLES[i][2];
    let precioCLP = formatoCLP(precio);
    let ingredientes = crearIngredientesHTML(BEBESTIBLES[i][3]);
    const bebestibleHTML = `<article class="col-6 col-sm-6 col-md-4 col-lg-3 my-2 my-md-3 p-1 border border-primary rounded">
            <div class="card m-0 m-sm-1 border border-primary">
                <img src=${imagen}
                class="card-img-top h-100 w-75 img-fluid m-auto" 
                alt=${nombre}
